...
class BankAccountCreateDTO(BaseDTO):
    ...
    user_id: int = Field(default=..., description=DataUtils.responses.user_id_validation_message)
    ...
    def validate_fields(cls, values):
        ...
        if (
            not account.is_length_between(cls.account_min_length, cls.account_max_length)
